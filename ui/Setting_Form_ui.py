...
class Ui_Setting_Form(object):
    def setupUi(self, Setting_Form):
        ...
        self.WorksAddres_lineEdit = QLineEdit(self.TaskSetting_tab)
        self.WorksAddres_lineEdit.setObjectName(u"WorksAddres_lineEdit")
        self.WorksAddres_lineEdit.setGeometry(QRect(90, 47, 421, 21))
        self.WorksAddres_lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.label_2 = QLabel(self.TaskSetting_tab)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 47, 81, 21))
        self.FindWorksAddress_BT = QPushButton(self.TaskSetting_tab)
        self.FindWorksAddress_BT.setObjectName(u"FindWorksAddress_BT")
        self.FindWorksAddress_BT.setGeometry(QRect(510, 40, 31, 31))
        self.FindWorksAddress_BT.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.FindWorksAddress_BT.setIcon(icon)
    ...
    def retranslateUi(self, Setting_Form):
        ...
        self.label_2.setText(QCoreApplication.translate("Setting_Form", u"Work Address", None))
        self.FindWorksAddress_BT.setText("")
